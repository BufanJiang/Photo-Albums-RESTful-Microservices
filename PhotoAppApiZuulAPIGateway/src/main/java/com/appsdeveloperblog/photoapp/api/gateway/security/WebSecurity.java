...
public class WebSecurity extends WebSecurityConfigurerAdapter{
    ...
    //http requests to h2 database,registration and login do not need authorization, other requests will need authorization
	@Override
    protected void configure(HttpSecurity http) throws Exception {
    	...
    	//make most(some do not need authorization) http requests that contained the authorization header to be reauthorized
